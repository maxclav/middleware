...
| `jwt` | Validate a JWT bearer token and place its claims in the context. | `WithHMACKey`, `WithKeyFunc`, `WithValidMethods`, `WithIssuer`, `WithAudience`, `WithLeeway`, `FromContext` | `golang-jwt/jwt/v5` |
